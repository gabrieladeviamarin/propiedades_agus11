...
if (isset($_POST['submit'])){
    ...
    $seguro = $_POST['seguro'];
    $codigo_seguro = isset($_POST['codigo_seguro']) && $_POST['codigo_seguro']!= ''? $_POST['codigo_seguro'] : 0;
    ...
    if ($check_seguro->rowCount() > 0) {
        ...
        $query_seguro = $con->prepare("UPDATE seguros SET tiene_seguro = $seguro, codigo_seguro = $codigo_seguro, precio = $precio_seguro WHERE id_lugar = $id_lugar");
        $query_seguro->execute();
    } else {
        // Insertar nuevo seguro
        $query_seguro = $con->prepare("INSERT INTO seguros (id_lugar, tiene_seguro, codigo_seguro, precio) VALUES ($id_lugar, $seguro, $codigo_seguro ,$precio_seguro)");
        $query_seguro->execute();
    }
